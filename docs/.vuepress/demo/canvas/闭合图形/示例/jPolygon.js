...
var ctx;
// var constArr = [{ "x": 420, "y": 169 }, { "x": 495, "y": 290 }, { "x": 363, "y": 304 }, { "x": 330, "y": 221 }]
var constArr = [{ "x": 337, "y": 198 }, { "x": 446, "y": 261 }, { "x": 338, "y": 350 }, { "x": 221, "y": 285 }, { "x": 213, "y": 161 }, { "x": 314, "y": 102 }, { "x": 394, "y": 150 }, { "x": 334, "y": 177 }, { "x": 286, "y": 219 }]
...
function drawPic () {
  ...
  ctx.lineCap = "square";
  ctx.beginPath();
  var len = constArr.length - 1
  for (var i = 0; i < constArr.length; i++) {
    if (i === len) {
      ctx.lineTo(constArr[0]['x'], constArr[0]['y']);
      ctx.closePath();
      ...
      if (i == 0) {
        ctx.moveTo(constArr[i]['x'], constArr[i]['y']);
        i !== len || point(constArr[i]['x'], constArr[i]['y']);
      } else {
        ctx.lineTo(constArr[i]['x'], constArr[i]['y']);
        i !== len || point(constArr[i]['x'], constArr[i]['y']);
      }
    }
  }
