// 前端常用的 59 个工具类【持续更新】---https://segmentfault.com/a/1190000021177663?utm_source=tag-newest
const regType = {
  // ip (127.0.0.1)
...
export const validateExp = (type, validateVal) => {
  return regType[type] && regType[type].test(validateVal)
}